<%-- 
    Document   : login
    Created on : 10 Feb, 2017, 4:00:16 PM
    Author     : Lenovo1
--%>
...
***********************************************/
    ...
    <div id="templatemo_menu">
        ...
        <h1>Login User</h1>           
        <form name="lgn" action="#" method="post">
            <table  align="center">
            <td colspan="2" align="center"> <h3>Login Information</h3 ></td>
...
<tr>
    <td colspan="2" align="center"><h3>Not a User ?</h3>
