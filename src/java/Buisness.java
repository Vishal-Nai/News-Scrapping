 ...
 * @author Lenovo1
 */
public class Buisness extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            user.visit("http://ahmedabadmirror.indiatimes.com/getsearchdata.cms?query=business");
...
//            request.setAttribute("el", element);
            ...
            user.visit("http://indianexpress.com/?s=business");
