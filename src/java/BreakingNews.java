 ...
 * @author Lenovo1
 */
public class BreakingNews extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            user.visit("http://ahmedabadmirror.indiatimes.com/getsearchdata.cms?query=breaking+news");
...
//            request.setAttribute("el", element);
            ...
            user.visit("http://indianexpress.com/?s=breaking+news");
            ...
            RequestDispatcher rd=request.getRequestDispatcher("BreakingNews.jsp");
